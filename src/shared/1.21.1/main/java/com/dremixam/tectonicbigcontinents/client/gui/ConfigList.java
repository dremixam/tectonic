package com.dremixam.tectonicbigcontinents.client.gui;

import com.dremixam.tectonicbigcontinents.client.ConfigListBuilder;
import com.dremixam.tectonicbigcontinents.client.gui.widget.SliderWidget;
...
import static com.dremixam.tectonicbigcontinents.client.gui.ConfigScreen.option;
...
public class ConfigList extends ContainerObjectSelectionList<ConfigList.Entry> implements ConfigListBuilder {
    ...
    public void addBoolean(String name, Consumer<Boolean> setter, boolean value, boolean base) {
        ...
        text.append(Component.translatable("config.tectonic_bigcontinents.default"));
