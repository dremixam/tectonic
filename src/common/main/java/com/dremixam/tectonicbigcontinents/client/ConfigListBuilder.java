package com.dremixam.tectonicbigcontinents.client;

import com.dremixam.tectonicbigcontinents.config.ConfigHandler;
import com.dremixam.tectonicbigcontinents.config.state.ConfigState;
import com.dremixam.tectonicbigcontinents.config.state.object.NoiseState;
import net.minecraft.client.gui.Font;

import java.util.function.Consumer;

import static com.dremixam.tectonicbigcontinents.config.state.ConfigState.Caves.*;
import static com.dremixam.tectonicbigcontinents.config.state.ConfigState.Continents.*;
import static com.dremixam.tectonicbigcontinents.config.state.ConfigState.General.*;
import static com.dremixam.tectonicbigcontinents.config.state.ConfigState.GlobalTerrain.*;
import static com.dremixam.tectonicbigcontinents.config.state.ConfigState.Islands.*;
import static com.dremixam.tectonicbigcontinents.config.state.ConfigState.Oceans.*;
